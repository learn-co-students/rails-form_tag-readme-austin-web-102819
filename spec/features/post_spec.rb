#create a capybara spec to enrure that going to posts/new takes us to our form
#after path works, add a spec to enure template is properly displaying html on the new post page
